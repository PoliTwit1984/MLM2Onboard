      ...
      <div className="py-24 px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            <h2 className="font-heading-72-9xl-hero font-[number:var(--heading-72-9xl-hero-font-weight)] tracking-[var(--heading-72-9xl-hero-letter-spacing)] [font-style:var(--heading-72-9xl-hero-font-style)] text-white text-center mt-[8px] mb-[8px] text-[55px]">Understand The Data Behind Every Shot Outcome</h2>
